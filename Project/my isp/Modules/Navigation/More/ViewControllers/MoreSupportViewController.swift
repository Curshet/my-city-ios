...
class MoreSupportViewController: UIViewController {
    
    private let viewModel: MoreSupportViewModelProtocol
    private let customView: MoreSupportCollectionViewProtocol
    private var subscriptions: Set<AnyCancellable>
    
    init(viewModel: MoreSupportViewModelProtocol, view: MoreSupportCollectionViewProtocol) {
