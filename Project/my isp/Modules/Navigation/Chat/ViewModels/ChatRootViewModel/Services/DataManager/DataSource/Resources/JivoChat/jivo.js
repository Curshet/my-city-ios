...
// заменим у текстареи атрибут enterkeyhint чтобы было
// https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/enterkeyhint
var maxTextareaSearchRetries = 50;
var currentTextareaSearchRetriesCount = 0;
var textareaInterval = setInterval(function () {
	var textarea = document.querySelector('textarea[class^="input"]');

	currentTextareaSearchRetriesCount++;

	if (currentTextareaSearchRetriesCount > maxTextareaSearchRetries) {
		// тут уже некого спасать
...
function loadJivosite() {
	...
	script.src = 'https://code.jivo.ru/widget/%s.js'.replace('%s', my_jivo_config.widget_id);
